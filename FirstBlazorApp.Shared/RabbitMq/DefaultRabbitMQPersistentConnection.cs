...
namespace FirstBlazorApp.Shared.RabbitMq
{
    public class DefaultRabbitMQPersistentConnection : IRabbitMQPersistentConnection
    {
        ...
        public bool TryConnect()
        {
            ...
            lock (sync_root)
            {
                ...
                {
                    Console.Error.WriteLine("FATAL ERROR: RabbitMQ connections could not be created and opened");
        ...
        void OnCallbackException(object sender, CallbackExceptionEventArgs e)
        {
            ...
            Console.Error.WriteLine("A RabbitMQ connection throw exception. Trying to re-connect...");
        ...
        void OnConnectionShutdown(object sender, ShutdownEventArgs reason)
        {
            ...
            Console.Error.WriteLine("A RabbitMQ connection is on shutdown. Trying to re-connect...");
